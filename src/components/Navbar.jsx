        ...
        <div className="mx-auto max-w-7xl px2 sm:px-6 lg:px-8">
          <div className="relative flex h-16 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              {/* Mobile menu button */}
              <DisclosureButton className="group relative inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-white/5 hover:text-white focus:-outline-offset-1 focus:outline-indigo-500">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm-inset-auto sm:ml-6 sm:pr-0">
              <button className="relative rounded-full p-1 text-gray-400 focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">
